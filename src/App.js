...
function App() {
 ...
 const [homeScore, setHomeScore] = useState(28);
 const [gameQuarter, setQuarter] = useState(0);
    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button 
          onClick={()=> setHomeScore(homeScore + 7)}          className="homeButtons__touchdown">Home Touchdown</button>
          <button 
        ...
        <div>
          <button 
          onClick={() => {if (gameQuarter < 4) {setQuarter(gameQuarter + 1)} else {setQuarter(gameQuarter * 0)}}}
          className="game_quarter">Game Quarter</button>
        </div>
      </section>
    </div>
  );
